  ...
  return (
    ...
    >
      ...
      >
        ...
        <a
          className="group bg-white flex rounded-full px-7 py-3 outline-none items-center gap-2 focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer border border-black/10"
          href="/CV.pdf"
          download
        >
          Download CV{' '}
